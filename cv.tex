...
Flu Forecast
\begin{list1}
\item[] Android app tthat displays vaccination levels, Twitter data, and current influenza rates for a user defined area.
\end{list1}
